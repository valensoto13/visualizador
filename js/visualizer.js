...
Si querés también te puedo hacer:

✅ un resumen muy simple de cómo funciona cada algoritmo
✅ un esquema visual explicando paso a paso
✅ o los 3 algoritmos explicados para una exposición oral

Solo decime cuál querés.      const tmp = STATE.items[s_i]; STATE.items[s_i] = STATE.items[s_min]; STATE.items[s_min]=tmp;
      res = {a:s_i,b:s_min,swap:true,done:false};
    } else {
      res = {a:s_i,b:s_i,swap:false,done:false};
    }
